 ...
 */
//Source: https://github.com/kolinger/iptables-web-gui
class Iptables
{
	...
	{
		return exec($this->executable . '-save');
	}
	...
	{
		return exec($this->executable . '-restore --test <<< "' . $configuration . '"');
	}
	...
	{
		return exec($this->executable . ' ' . $parameters);
	}
}